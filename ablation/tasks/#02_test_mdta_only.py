# E:/restormer+volterra/ablation/tasks/test_mdta_only_all.py
import sys, os, torch
...
CKPT = r"E:\restormer+volterra\ablation\checkpoints\train_mdta_only\mdta_only_epoch75_psnr25.40_ssim0.7895.pth"
BATCH_SIZE = 1
...
if __name__ == "__main__":
    ...
    # ✅ 최종 요약
    print("\n==== Final Results (MDTA Only + Volterra) ====")
