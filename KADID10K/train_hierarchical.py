...
# ✅ 경로 설정
CSV_PATH = "E:/NEW/data/KADID10K/kadid10k.csv"
IMG_DIR = "E:/NEW/data/KADID10K/images"
CHECKPOINT_DIR = "E:/NEW/checkpoints/hierarchical_kadid"
RESUME_PATH = os.path.join(CHECKPOINT_DIR, "epoch_70.pth")
...
def train():
    ...
    model.load_state_dict(torch.load(RESUME_PATH, map_location=DEVICE), strict=False) # ✅ 체크포인트에서 로드
