...
GOPRO_TEST_DIR = r"E:/restormer+volterra/data/GOPRO_Large/test/GOPR0384_11_00"
...
def main():
    ...
    evaluate(model,
             input_dir=os.path.join(GOPRO_TEST_DIR, "blur"),
             target_dir=os.path.join(GOPRO_TEST_DIR, "sharp"),
             name="GoPro")
