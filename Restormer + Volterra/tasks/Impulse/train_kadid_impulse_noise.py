...
# ---------------- Paths ----------------
BASE_DIR   = r"E:/restormer+volterra/data/kadid_seperate/impulse noise"
PAIRS_TXT  = os.path.join(BASE_DIR, "pairs_impulse.txt")
SAVE_DIR   = r"E:/restormer+volterra/checkpoints/kadid_impulse_noise"
...
# ---------------- Main ----------------
def main():
    print("🚀 KADID impulse noise training (no leakage by GT stem)")
    # 1) 페어 읽기 & split
