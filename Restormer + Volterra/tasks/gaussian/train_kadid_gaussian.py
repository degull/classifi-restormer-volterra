...
SAVE_DIR   = r"E:/restormer+volterra/checkpoints/kadid_gaussian"
...
def read_pairs_txt(base_dir: str, txt_path: str) -> List[Tuple[str, str]]:
    """
    pairs_gaussian.txt의 각 줄: 'blur/level_1/I01_01_01.png gt/I01.png'
    반환은 (dist_abs, gt_abs)
    """
    pairs = []
...
# ---------------- Main ----------------
def main():
    print("🚀 KADID Gaussian Blur training (no leakage by GT stem)")
    # 1) 페어 읽기 & split
